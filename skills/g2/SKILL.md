...
> **详细文档**: [axis 配置](references/components/g2-comp-axis-config.md) | [log 比例尺](references/scales/g2-scale-log.md)
...
> **详细文档**: [仪表盘](references/recipes/g2-recipe-dashboard.md) | [漏斗图](references/recipes/g2-recipe-funnel.md) | [时序对比](references/recipes/g2-recipe-timeseries-compare.md)
