 ...
 *   - includeContent: Whether to include full markdown content of each skill (default: false).
 * @example retrieve('bar chart', 'g2', 1);
 * @returns An array of skills matching the query.
 */
export function retrieve(query: string, library = 'g2', topk = 7, options: RetrieveOptions = {}): Skill[] {
